...
# Latest Revision before Latest Revision before Latest Revision: 31 May 2005,
#     23.17 CET
#
#
# TO DO List/Caveats
...
EnhancedStatusBar Is A Slight Modification (Actually A Sub classing) Of
wx.StatusBar.
It Allows You To Add Almost Any Widget You Like To The wx.StatusBar Of Your
Main Frame Application And Also To Layout Them Properly.


What It Can Do:

1) Almost All The Functionalities Of wx.StatusBar Are Still Present;
2) You Can Add Different Kind Of Widgets Into Every Field Of The
    EnhancedStatusBar;
3) The AddWidget() Methods Accepts 2 Layout Inputs:
   - horizontalalignment: This Specify The Horizontal Alignment For Your
     Widget, And Can Be ESB_EXACT_FIT, ESB_ALIGN_CENTER_HORIZONTAL,
     ESB_ALIGN_LEFT And ESB_ALIGN_RIGHT;
...
class EnhancedStatusBar(wx.StatusBar):
    ...
    def __init__(self, parent, _id=wx.ID_ANY, style=wx.ST_SIZEGRIP,
        ...
        wx.StatusBar.__init__(self, parent, _id, style, name)
    ...
    def OnSize(self, event):
        ...
        for pos, item in self._items.items():
            widget, horizontalalignment, verticalalignment = (item.widget,
...
#            widgetpos = widget.GetPosition()
            ...
            if horizontalalignment == ESB_EXACT_FIT:
                ...
                if verticalalignment == ESB_EXACT_FIT:
                    ...
                    widget.SetSize((rect.width - 2, widgetsize[1]))
                    widget.SetPosition((rect.x - 1,
                                                rect.height - widgetsize[1]))
    ...
    def AddWidget(self, widget,
        ...
        - horizontalalignment: This Can Be One Of:
          ...
          b) ESB_ALIGN_CENTER_HORIZONTAL: The Widget Will Be Centered
             Horizontally In The StatusBar Field;
          c) ESB_ALIGN_LEFT: The Widget Will Be Left Aligned In The StatusBar
             Field;
          d) ESB_ALIGN_RIGHT: The Widget Will Be Right Aligned In The StatusBar
             Field;

        - verticalalignment:
          a) ESB_EXACT_FIT: The Widget Will Fit Vertically The StatusBar Field
             Height;
          b) ESB_ALIGN_CENTER_VERTICAL: The Widget Will Be Centered Vertically
             In The StatusBar Field;
          c) ESB_ALIGN_BOTTOM: The Widget Will Be Bottom Aligned In The
             StatusBar Field;
          d) ESB_ALIGN_TOP: The Widget Will Be TOP Aligned In The StatusBar
             Field;
        ...
        if horizontalalignment not in [ESB_ALIGN_CENTER_HORIZONTAL,
            ...
            raise Exception('\nERROR: Parameter "horizontalalignment" Should '\
                  'Be One Of "ESB_ALIGN_CENTER_HORIZONTAL", "ESB_ALIGN_LEFT",'\
        ...
        if verticalalignment not in [ESB_ALIGN_CENTER_VERTICAL, ESB_EXACT_FIT,
            ...
            raise Exception('\nERROR: Parameter "verticalalignment" Should '\
                  'Be One Of "ESB_ALIGN_CENTER_VERTICAL", "ESB_ALIGN_TOP",'\
        ...
        self._items[pos] = EnhancedStatusBarItem(widget, pos,
